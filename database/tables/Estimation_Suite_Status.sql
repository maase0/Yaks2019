...
CREATE TABLE `Status` (
  ...
  CONSTRAINT `fkidProjectStatus` FOREIGN KEY (`idProject`) REFERENCES `Project` (`idProject`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
-- Dump completed on 2019-12-10 17:10:03
